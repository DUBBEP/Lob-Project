...
public class ChatLogAPITest : MonoBehaviour
{
    // Replace type with your backend manager
    [SerializeField] private BackendChatLogConnectors apiManager;
    ...
    private async void DebugObjects()
    {
        ...
        List<ChatLog> items = await apiManager.GetIndexAsync();
        ...
        {
            Debug.Log("Either the list is empty or the request failed.");
        }
    }
}